...
// 💡 아래의 DEFAULT_SYNC_URL 변수에 생성하신 구글 웹앱 URL을 입력해두면,
// 다른 선생님들 노트북에서 따로 세팅할 필요 없이 즉시 같은 구글 시트로 자동 동기화됩니다!
const DEFAULT_SYNC_URL = 'https://script.google.com/macros/library/d/1yQKH569wDmSutduT3kMWU6UiUpfTaAf5WGq0FdIZg1s2gT6YJeBhmCJ4/1';

function loadSyncConfiguration() {
  const savedUrl = localStorage.getItem('roundtable_sync_url') || DEFAULT_SYNC_URL;
